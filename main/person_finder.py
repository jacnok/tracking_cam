...
def detect_bounding_box(vid):                                           # this function takes a video, outputs faces
    gray_image = cv2.cvtColor(vid, cv2.COLOR_BGR2GRAY)                  # this turns things into grayscale
    faces = face_classifier.detectMultiScale(                           # this function 
        gray_image, 1.1, 5, minSize=(80, 80)
        )
